...
(function () {
  ...
  // Matches TDX's native validation error look: red text on a light blue
  // highlight, no border or box, so it's visually consistent with the
  // platform's own "field is required" messages.
